...
public class Reasoner implements IReasoner {
     ...
     * ucciri@gmail.com -> parent부터 add 되어야 함 !!!
     *
     * @param rule
     * @return
     */
    ...
    {        
        ...
        addingRule.setRuleId(rule.getRuleId());
        addingRule.setParent(rule.getParent());
        ...
        {            
            ...
            {
            	Logger.error("rule has parent, but parent not in firedRules : " + rule.toString());
            	return false;
            }
        }        
