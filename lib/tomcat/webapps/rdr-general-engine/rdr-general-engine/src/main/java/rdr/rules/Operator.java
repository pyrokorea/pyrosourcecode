...
public class Operator {
    ...
    /**
     * Operator identifier for MISSING Operator
     */    
    public final static int MISSING = 17;    
    /**
     * Operator identifier for NOT_MISSING Operator
     */    
    public final static int NOT_MISSING = 18;    
    ...
    public final static String[] operatorNames = {"NULL_OP", "==", "!=", 
        ...
        "Before", "Before or Equals", "After", "After or Equals", "Contain Exact Term", "Not Contain Exact Term", "MISSING", "NOT MISSING"};
     ...
     */
    public void setOperatorCode(int op) {
        this.operator = op;
    }    
    ...
    public static Operator stringToOperator(String str) {
        ...
        if (str.equals("MISSING")) {
            return new Operator(MISSING);
        }
        if (str.equals("NOT MISSING")) {
            return new Operator(NOT_MISSING);
        }
    ...
    public String toString() {
        return operatorNames[getOperatorCode()];
    }    
}
