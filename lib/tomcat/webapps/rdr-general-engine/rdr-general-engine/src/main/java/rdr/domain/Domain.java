...
public class Domain {
     ...
     * case structure
     */
    private CaseStructure caseStructure = new CaseStructure();
     ...
     * @param description 
     */
    public Domain(int domainId, String domainName, String reasonerType, String description){
     ...
     * @param description 
     */
    public Domain(String domainName, String reasonerType, String description){
        this.domainName = domainName;
        this.reasonerType = reasonerType;
        this.problemDescription = description;
        this.caseStructure = new CaseStructure();
