...
public class PBSDBManager 
{
			                           ...
			                           LinkedHashMap<String, String> pMap)
	{
		...
		String sqlFn = "PBSReceiptDataSelect.sql";
	...
	public static void loadTestResultData(String pLmbCode,
							       ...
							       ArrayList<PBSResultDTO> dl)
	{
		if (dl == null) return;

		String sqlFn = "PBSResultDataSelect.sql";
		...
		try
		{
			...
			for (int i = 0; i < tList.size(); i++)
			{
				...
				PBSResultDTO dto = new PBSResultDTO();
	...
	public static TreeMap<String, String> getTestComments(String pCommentCode)
	{
		...
		String sqlFn = "PBSTestCommentSelect.sql";
	...
	/** 부속코드 -> default 판정 */
	public static TreeMap<String, String> getDefaultDecision(String pLmbCode, String pTestCode)
	{
		TreeMap<String, String> rMap = new TreeMap<String, String>();
		
		String sqlFn = "PBSDefaultDecisionSelect.sql";
	...
	/** 부속코드 -> 소견그룹 */
	public static TreeMap<String, String> getCommentGroup(String pLmbCode, String pTestCode)
	{
		TreeMap<String, String> rMap = new TreeMap<String, String>();
		
		String sqlFn = "PBSCommentGroupSelect.sql";
