...
(
    ...
    `ATTRIBUTE_NAME`  VARCHAR(255)    NOT NULL     COMMENT '사례항목명',
    `ATTRIBUTE_DESC`  VARCHAR(512)    NULL         COMMENT '사례항설목명',
    `CREATION_DATE`   DATETIME        DEFAULT CURRENT_TIMESTAMP  COMMENT '생성일시',
    `UPDATE_DATE`     DATETIME        NULL         COMMENT '수정일시',
    `USER_ID`         VARCHAR(50)     NULL         COMMENT '사용자ID',
...
ALTER TABLE TB_CASE_STRUCTURE ADD CONSTRAINT FK_CASESTRUCTURE_DOMAINDETAIL_DOMAINNAME FOREIGN KEY (DOMAIN_NAME)
 ...
 REFERENCES TB_CASE_STRUCTURE (DOMAIN_NAME, ATTRIBUTE_ID)  ON DELETE RESTRICT ON UPDATE RESTRICT;
 ...
 REFERENCES TB_RULE_STRUCTURE (DOMAIN_NAME, RULE_ID)  ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--ALTER TABLE TB_RULE_CORNERSTONES ADD INDEX IDX_RULECORNERSTONE_CASEID(DOMAIN_NAME, CASE_ID);
...
-- REFERENCES TB_RULE_CORNERSTONES (DOMAIN_NAME, CASE_ID)  ON DELETE RESTRICT ON UPDATE RESTRICT;
