...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_DESCRIPTION',
    '사례항설목명',
   'USER', DBO, 'TABLE', 'TB_CASE_STRUCTURE', 'COLUMN', 'ATTRIBUTE_DESC'
GO
...
ALTER TABLE TB_CASE_STRUCTURE ADD CONSTRAINT FK_CASESTRUCTURE_DOMAINDETAIL_DOMAINNAME FOREIGN KEY (DOMAIN_NAME)
 REFERENCES TB_DOMAIN_DETAIL (DOMAIN_NAME)  ON DELETE NO ACTION ON UPDATE NO ACTION
GO

 ALTER TABLE TB_CATEGORICAL_VALUE ADD CONSTRAINT FK_CATEGORICALVALUE_CASESTRUCTURE_ATTRIBUTEID FOREIGN KEY (DOMAIN_NAME, ATTRIBUTE_ID)
 REFERENCES TB_CASE_STRUCTURE (DOMAIN_NAME, ATTRIBUTE_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
GO
 ...
 ALTER TABLE TB_RULE_CONDITIONS ADD CONSTRAINT FK_RULECONDITIONS_RULESTRUCTURE_RULEID FOREIGN KEY (DOMAIN_NAME, RULE_ID)
 REFERENCES TB_RULE_STRUCTURE (DOMAIN_NAME, RULE_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
ALTER TABLE TB_RULE_CORNERSTONES ADD CONSTRAINT FK_RULECORNERSTONES_RULESTRUCTURE_RULEID FOREIGN KEY (DOMAIN_NAME, RULE_ID)
 REFERENCES TB_RULE_STRUCTURE (DOMAIN_NAME, RULE_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION
GO

--CREATE INDEX IDX_RULECORNERSTONE_CASEID ON TB_CORNERSTONE_CASE(DOMAIN_NAME, CASE_ID)
--GO

--ALTER TABLE TB_CORNERSTONE_CASE ADD CONSTRAINT FK_CORNERSTONECASE_RULECORNERSTONES_CASEID FOREIGN KEY (DOMAIN_NAME, CASE_ID)
-- REFERENCES TB_RULE_CORNERSTONES (DOMAIN_NAME, CASE_ID)  ON DELETE NO ACTION ON UPDATE NO ACTION
--GO
